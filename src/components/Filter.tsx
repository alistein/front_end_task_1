        ...
        <div className='grid grid-cols-10 gap-4 py-4'>
            ...
            <div className='col-span-2'>
                <select
                    ...
                    className='border-slate-300 border-2 py-2 px-2 outline-none w-full rounded-sm col-span-2' >
            ...
            <button onClick={() => {sendFilteredData({ fullname: filteredFullname, email: filteredEmail, role: filteredRole})}} className='bg-slate-400 hover:scale-110 active:scale-95 transition-transform text-white font-bold'>Search</button>
            <button onClick={() => {
                setFilterEmail('')
                setFilterFullname('')
                setFilterRole('')
                sendFilteredData({ fullname: '', email: '', role: ''});
            }} className='bg-slate-400 hover:scale-110 active:scale-95 transition-transform text-white font-bold'>Clear</button>
